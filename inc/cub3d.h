...
** raycasting defines
*/
# define PLAYER_DEF_ROT_SPEED 0.12
...
# define X_MASK_KEYDOWN 1L
# define X_MASK_KEYRELEASE 2L
...
typedef struct			s_raycast
{
	...
	t_flvector2			campos;
	t_flvector2			intercept;
	t_flvector2			delta_intercept;
	t_bool				hit;
	t_bool				side;
	int					item;
	double				distance;
...
*/
t_bool					construct_scenedata(t_scenedata *scenedata,
							char *filename);
...
t_bool					extract_scenedata_from_line(t_scenedata *scenedata,
							char *line);
...
t_bool					scenedesc_process_textures(t_scenedata *scenedata,
							char *line);
t_bool					scenedesc_process_textures_sprites(
							t_scenedata *scenedata, char *line);
t_bool					scenedesc_process_colors(
							t_scenedata *scenedata, char *line);
t_bool					scenedesc_process_map(
							t_scenedata *scenedata, char *line);
...
*/
t_bool					scan_map_and_find_player_position(
							t_scenedata *scenedata);
...
void					mlx_wpixel(t_mlx_image *mlximage, t_vector2 pos,
							int color);
...
void					insert_sprite(t_raycast *raycast, int x, int y,
							int item);
...
void					keystate_unsetflag(unsigned int *keystate,
							int keycode);
/*
** cub3d.c
*/
...
void					calc_ray_position_and_direction(t_raycast *raycast,
							t_player *player);
void					calc_pos_in_cameraplane(t_raycast *raycast,
							t_cub3d *cub3d);
void					calc_tilestep_and_intercept(t_raycast *raycast,
							t_cub3d *cub3d);
...
void					draw_colored_floors_and_ceiling(t_mlx *mlx,
							t_scenedata *scenedata);
void					draw_textured_floor_and_ceiling_norm1(
							t_raycast *raycast,
						t_cub3d *cub3d, t_draw_tex_floor_ceiling *q);
void					draw_textured_floor_and_ceiling(t_raycast *raycast,
							t_cub3d *cub3d);
void					draw_textured_line_norm0(t_draw_tex_line *s,
